...
class Sphere :
    ...
    # Fonction pour afficher la sphère
...
# Fonction pour afficher la sphère avec les flèches des forces
def plot_sphere_avec_forces(self, forces):
    ...
    for force in forces:
        ...
        start_point = [0, 0, 0]  # Centre de la sphère
...
# Création du maillage pour la sphère
